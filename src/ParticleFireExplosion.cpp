...
int main(int argc, char* argv[]) {
	...
	memset(buffer, 0xFFFFFF, SCREEN_WIDTH * SCREEN_HEIGHT * sizeof(Uint32)); //paint all buffer with 255 (it is the white color)

	//Update the buffer of pixel data
	/*************************************************************/
	SDL_UpdateTexture(texture, NULL, buffer, SCREEN_WIDTH * sizeof(Uint32) // The pitch -> The number of bytes in a row of pixel data.
			);
